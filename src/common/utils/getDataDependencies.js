/**
  * https://github.com/erikras/react-redux-universal-hot-example/blob/master/src/helpers/getDataDependencies.js
  *
  ...
  */
export default function (components, getState, dispatch, location, params, url, deferred) {
    ...
    return components
        ...
        .map(fetchData => fetchData(getState, dispatch, location, params, url)); // 3
};
